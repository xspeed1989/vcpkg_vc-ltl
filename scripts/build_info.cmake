...
if(DEFINED VCPKG_CRT_LINKAGE_DEBUG)
    file(WRITE  ${BUILD_INFO_FILE_PATH} "CRTLinkageDebug: ${VCPKG_CRT_LINKAGE_DEBUG}\n")
    file(APPEND  ${BUILD_INFO_FILE_PATH} "CRTLinkage: ${VCPKG_CRT_LINKAGE}\n")
else()
    file(WRITE  ${BUILD_INFO_FILE_PATH} "CRTLinkageDebug: ${VCPKG_CRT_LINKAGE}\n")
    file(APPEND  ${BUILD_INFO_FILE_PATH} "CRTLinkage: ${VCPKG_CRT_LINKAGE}\n")
endif()
