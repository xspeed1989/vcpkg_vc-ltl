...
if(DEFINED CMAKE_BUILD_TYPE AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    # Must add -DVCPKG_CRT_LINKAGE_DEBUG=${VCPKG_CRT_LINKAGE_DEBUG} to ports\vcpkg-cmake\vcpkg_cmake_configure.cmake
    set(VCPKG_CRT_LINKAGE ${VCPKG_CRT_LINKAGE_DEBUG})
endif()
...
if(CMAKE_BUILD_TYPE STREQUAL "Release") 
    # # VCPKG_IS_LTL is undefined when the callstack doesn't inlcude tiprlet file, so we need inlude the file manually
    # set(TRIPLET_FILE "${_VCPKG_ROOT_DIR}/triplets/${VCPKG_TARGET_TRIPLET}.cmake")
    # if(NOT EXISTS ${TRIPLET_FILE})
    #     set(TRIPLET_FILE "${_VCPKG_ROOT_DIR}/triplets/community/${VCPKG_TARGET_TRIPLET}.cmake")
    # endif()
    # include("${TRIPLET_FILE}")
    
    # Must add -DVCPKG_IS_LTL=${VCPKG_IS_LTL} to ports\vcpkg-cmake\vcpkg_cmake_configure.cmake
    if(VCPKG_IS_LTL EQUAL 1)
        include("${_VCPKG_ROOT_DIR}/scripts/VC-LTL_setup.cmake")
    endif()
endif()
